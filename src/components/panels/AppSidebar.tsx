...
import { BarChart3, Clapperboard, Film, Library, Settings as SettingsIcon } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarFooter,
...
export default function AppSidebar() {
  ...
  return (
    <Sidebar collapsible="icon">
      <SidebarHeader>
        <div className="flex items-center gap-2 group-data-[collapsible=icon]:w-full group-data-[collapsible=icon]:flex-col">
          <Link href="/" className="flex size-9 shrink-0 items-center justify-center rounded-xl group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:w-full" aria-label="ThumbGen home">
          ...
          <SidebarTrigger className="shrink-0 group-data-[collapsible=icon]:h-8 group-data-[collapsible=icon]:w-full" />
        </div>
      </SidebarHeader>
